...
import org.apache.spark.rdd.AssumedPartitionsNewHadoopRDD.AssumedPartitionsNewHadoopMapPartitionsWithSplitRDD
 ...
 */
@DeveloperApi
class AssumedPartitionsNewHadoopRDD[K, V](
    sc : SparkContext,
  ...
  override def getPartitions: Array[Partition] = {
    ...
    val rsplits = inputFormat.getSplits(jobContext)
    val rawSplits = rsplits.toArray(new Array[InputSplit](rsplits.size())).sorted(NewHadoopSplitOrdering).toArray
  ...
  def mapPartitionsWithInputSplit[U: ClassTag](
    ...
    new AssumedPartitionsNewHadoopMapPartitionsWithSplitRDD(this, f, preservesPartitioning)
  }
  ...
  override def persist(storageLevel: StorageLevel): this.type = {
    if (storageLevel.deserialized) {
      logWarning("Caching AssumedPartitionsNewHadoopRDDs as deserialized objects usually leads to undesired" +
...
private[spark] object AssumedPartitionsNewHadoopRDD {
  /**
   ...
   */
  private[spark] class AssumedPartitionsNewHadoopMapPartitionsWithSplitRDD[U: ClassTag, T: ClassTag](
      prev: RDD[T],
...
private[spark] object NewHadoopSplitOrdering extends Ordering[InputSplit] {
...
private[spark] class WholeTextFileRDD(
    ...
    @transient conf: Configuration,
    minPartitions: Int)
  extends AssumedPartitionsNewHadoopRDD[String, String](sc, inputFormatClass, keyClass, valueClass, conf) {
